...
def load_alberta_services() -> List[Dict]:
    ...
    edmonton_services = [
        {
            'name': 'Access 24/7 Edmonton',
            'category': 'Mental Health & Crisis Services',
            'contact': '13211 Fort Rd NW, 780-424-2424',
            'description': 'Open 7 days 8am-10pm, one-stop adult intake for mental health and addiction services',
        ...
        },
        {
            ...
            'description': 'Adult mobile crisis response - 24/7 support for mental health emergencies',
        ...
        },
        {
            ...
            'category': 'Youth Mental Health Services',
            'contact': '780-413-4733',
            'description': 'Child and youth mobile crisis response',
        ...
        },
        {
            ...
            'category': 'Detox & Medical Withdrawal Services',
            'contact': '780-424-8335',
            'description': 'Medically supported detox 18+, 24/7 services',
        ...
        },
        {
            ...
            'category': 'Harm Reduction Services',
            'contact': '780-424-4106',
            'description': 'Harm reduction, wraparound addiction support, walk-in available',
        ...
        },
        {
            ...
            'description': 'Harm reduction for those experiencing homelessness with alcohol dependency',
        ...
        },
        {
            ...
            'description': 'Faith-based residential recovery, emergency shelter - 24/7',
        ...
        },
        {
            ...
            'category': 'Mens Residential Recovery',
            'contact': '780-422-2018 x312',
            'description': 'Mens residential recovery program for men 18-60',
        ...
        },
        {
            ...
            'category': 'Womens Residential Recovery',
            'contact': '780-422-2018 x203',
            'description': 'Womens residential recovery, 1-year program for women 18+',
        ...
        },
        {
            ...
            'description': 'Mens residential alcoholism recovery for men 18+',
        ...
        },
        {
            ...
            'description': 'Womens residential addiction treatment for women 18+',
        ...
        },
        {
            ...
            'description': '1-year mens residential recovery program (one of few in Canada)',
        ...
        },
        {
            ...
            'description': 'Mens residential substance use recovery for men 16+',
        ...
        },
        {
            ...
            'category': 'Mens Supportive Housing',
        ...
        },
        {
            ...
            'category': 'Affordable Counselling Services',
            'contact': 'counselling@ywcaedm.org',
            'description': 'Affordable counselling, sliding scale $5-$200/session',
        ...
        },
        {
            ...
            'category': 'Family Counselling Services',
            'contact': '780-423-2831',
            'description': 'Family counselling, first session free then sliding scale',
        ...
        },
        {
            ...
            'category': 'LGBTQ2S+ Support Services',
            'contact': 'pridecentreofedmonton.ca',
            'description': 'LGBTQ2S+ resources, counselling, community support',
        ...
        },
        {
            ...
            'description': 'Children/youth mental health, Indigenous programs, classroom support',
        ...
        {
            'name': 'YESS',
            'category': 'Youth Emergency Shelter',
            'contact': 'yess.org',
            'description': 'Youth emergency shelter and support services, ages 15-24, 24/7',
        ...
        },
        {
            ...
            'category': 'Residential Addiction Treatment',
            'contact': '18750 18 St NW, Edmonton',
            'description': 'Adult residential addiction treatment (AHS)',
        ...
        },
        {
            ...
            'category': 'Social Services Navigation',
            'contact': 'Provincial referrals, multi-service hub',
            'description': 'Multi-service hub for social services navigation, walk-in available',
        ...
        },
        {
            ...
            'category': 'Food Banks & Emergency Food',
            'contact': '11508 120 St NW, 780-425-4190',
            'description': 'Food bank serving 43,000+ people monthly, Beyond Food program',
        ...
        },
        {
            ...
            'category': 'Specialized Mental Health Treatment',
            'contact': 'envisionmindcare.com',
            'description': 'Innovative mental health treatment: psychedelic-assisted therapy, ketamine, TMS (first in Alberta)',
    ...
    lethbridge_services = [
        {
            ...
            'category': 'Mental Health & Addiction Services',
            'contact': '801 1 Ave S, 403-381-5260',
            'description': 'Outpatient addiction/mental health services, self-referral, walk-in available',
        ...
        },
        {
            ...
            'description': 'Crisis Intervention Team, DOT outreach, call 403-328-5465 (328-LINK)',
        ...
        },
        {
            ...
            'description': 'Emergency shelter with substance use support, 24/7',
        ...
        },
        {
            ...
            'category': 'Stabilization & Withdrawal Management',
            'contact': 'Licensed facility',
            'description': 'Stabilization services, 24/7',
        ...
        },
        {
            ...
            'description': 'Detoxification services, 24/7',
        ...
        },
        {
            ...
            'description': '14-week mens residential recovery program',
        ...
        },
        {
            ...
            'category': 'Indigenous Wellness Services',
            'contact': 'ulethbridge.ca/indigenous',
            'description': 'Land-based healing, Elder support, cultural activities',
