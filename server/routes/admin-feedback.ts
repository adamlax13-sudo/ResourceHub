...
export function registerAdminFeedbackRoutes(app: Express): void {
  ...
  app.get("/api/admin/feedback", adminReadLimiter, adminAuth, asyncHandler(async (req: Request, res: Response) => {
  ...
  // ============= NEW FEEDBACK COUNT =============
  app.get("/api/admin/feedback/count", adminReadLimiter, adminAuth, asyncHandler(async (_req: Request, res: Response) => {
  ...
  app.patch("/api/admin/feedback/:id/status", adminWriteLimiter, adminAuth, asyncHandler(async (req: Request, res: Response) => {
  ...
  app.get("/api/admin/feedback/votes", adminReadLimiter, adminAuth, asyncHandler(async (_req: Request, res: Response) => {
