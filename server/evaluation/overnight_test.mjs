...
const BATCHES = [
  ...
  },
  {
    ...
    queries: [
      ...
      { query: "eviction help Alberta", expect: { mustMatch: ["tenant", "legal"] } },
      ...
      { query: "baby formula and diapers help", expect: { mustMatch: ["baby", "family"] } },
      ...
      { query: "utility bill help can't pay power", expect: { mustMatch: ["financial", "utility"] } },
  ...
  },
  {
    ...
    queries: [
      ...
      { query: "anger management classes", expect: { mustMatch: ["anger management"] } },
  ...
  },
  {
    ...
    queries: [
      ...
      { query: "residential school survivors support", expect: { mustMatch: ["Indigenous", "residential school"] } },
      { query: "indigenous healing circle", expect: { mustMatch: ["Indigenous"] } },
      { query: "NIHB mental health coverage", expect: { mustMatch: ["Indigenous"] } },
      // Newcomer
      { query: "refugee settlement help Calgary", expect: { location: "Calgary", mustMatch: ["refugee", "settlement"] } },
      { query: "ESL classes free", expect: { mustMatch: ["newcomer", "English"] } },
      { query: "immigration legal help", expect: { mustMatch: ["immigrant", "legal"] } },
      { query: "foreign credential recognition", expect: { mustMatch: ["newcomer", "credential"] } },
      // Veteran
      ...
      { query: "military family support", expect: { mustMatch: ["military", "family"] } },
      // Student
      { query: "university counselling services", expect: { mustMatch: ["student", "counselling"] } },
      { query: "student mental health crisis", expect: { mustMatch: ["student", "mental health"] } },
