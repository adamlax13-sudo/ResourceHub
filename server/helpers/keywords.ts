...
export const KEYWORD_EXPANSIONS: Record<string, string[]> = {
  ...
  'food': ['meal', 'nutrition', 'hungry', 'groceries', 'foodbank', 'hamper', 'soup kitchen'],
  'donation': ['donate', 'free', 'clothing bank', 'furniture', 'hamper', 'thrift'],
  ...
  'self-harm': ['self-injury', 'cutting', 'crisis', 'suicide prevention', 'mental health', 'youth'],
  ...
  'student': ['university', 'college', 'campus', 'academic', 'ucalgary', 'uofa', 'uofl'],
  'ucalgary': ['university of calgary', 'u of c', 'campus', 'student', 'wellness services'],
  'uofa': ['university of alberta', 'u of a', 'campus', 'student'],
  ...
  'caregiver': ['respite', 'caring for', 'burnout', 'family support', 'relief'],
  'respite': ['caregiver', 'caregiver support', 'relief', 'break', 'day program'],
