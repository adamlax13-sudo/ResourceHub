...
export default function ServiceImport() {
  ...
  return (
    <div className="p-6 max-w-4xl space-y-6">
      <h2 className="text-xl font-semibold text-white">Import Services</h2>

      {/* Input */}
      <Card className="bg-slate-800 border-slate-700">
        <CardHeader className="pb-2">
          <CardTitle className="text-white text-base">Service Data (JSON)</CardTitle>
        </CardHeader>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-700/50">
                    <th className="text-left px-3 py-2 text-slate-300 font-medium">#</th>
      ...
      {importResult && (
        <Card className="bg-slate-800 border-slate-700">
          <CardHeader className="pb-2">
            <CardTitle className="text-white text-base">Import Results</CardTitle>
          </CardHeader>
