...
import { User, Loader2, Check, LogOut, Sparkles, Heart, MapPin, Menu, Home } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <h1 className="text-lg sm:text-3xl font-display font-bold">{t('profile.title')}</h1>
            </div>
