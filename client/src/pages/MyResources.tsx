...
import { ArrowLeft, Trash2, PlayCircle, CheckCircle, Loader2, LogOut } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <h1 className="text-lg sm:text-2xl font-display font-bold">{t('myResources.title')}</h1>
              </div>
            </div>
